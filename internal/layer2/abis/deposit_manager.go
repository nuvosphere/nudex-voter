...
//
// Solidity: function deposits(address , uint256 ) view returns(address targetAddress, uint256 amount, uint256 chainId, bytes txInfo, bytes extraInfo)
...
//
// Solidity: function recordDeposit(address targetAddress, uint256 amount, uint256 chainId, bytes txInfo, bytes extraInfo) returns()
func (_DepositManagerContract *DepositManagerContractTransactor) RecordDeposit(opts *bind.TransactOpts, targetAddress common.Address, amount *big.Int, chainId *big.Int, txInfo []byte, extraInfo []byte) (*types.Transaction, error) {
	return _DepositManagerContract.contract.Transact(opts, "recordDeposit", targetAddress, amount, chainId, txInfo, extraInfo)
}

// RecordDeposit is a paid mutator transaction binding the contract method 0xbac89758.
//
// Solidity: function recordDeposit(address targetAddress, uint256 amount, uint256 chainId, bytes txInfo, bytes extraInfo) returns()
func (_DepositManagerContract *DepositManagerContractSession) RecordDeposit(targetAddress common.Address, amount *big.Int, chainId *big.Int, txInfo []byte, extraInfo []byte) (*types.Transaction, error) {
	return _DepositManagerContract.Contract.RecordDeposit(&_DepositManagerContract.TransactOpts, targetAddress, amount, chainId, txInfo, extraInfo)
}

// RecordDeposit is a paid mutator transaction binding the contract method 0xbac89758.
//
// Solidity: function recordDeposit(address targetAddress, uint256 amount, uint256 chainId, bytes txInfo, bytes extraInfo) returns()
func (_DepositManagerContract *DepositManagerContractTransactorSession) RecordDeposit(targetAddress common.Address, amount *big.Int, chainId *big.Int, txInfo []byte, extraInfo []byte) (*types.Transaction, error) {
	return _DepositManagerContract.Contract.RecordDeposit(&_DepositManagerContract.TransactOpts, targetAddress, amount, chainId, txInfo, extraInfo)
}

// RecordWithdrawal is a paid mutator transaction binding the contract method 0x57673f43.
//
// Solidity: function recordWithdrawal(address targetAddress, uint256 amount, uint256 chainId, bytes txInfo, bytes extraInfo) returns()
func (_DepositManagerContract *DepositManagerContractTransactor) RecordWithdrawal(opts *bind.TransactOpts, targetAddress common.Address, amount *big.Int, chainId *big.Int, txInfo []byte, extraInfo []byte) (*types.Transaction, error) {
	return _DepositManagerContract.contract.Transact(opts, "recordWithdrawal", targetAddress, amount, chainId, txInfo, extraInfo)
}

// RecordWithdrawal is a paid mutator transaction binding the contract method 0x57673f43.
//
// Solidity: function recordWithdrawal(address targetAddress, uint256 amount, uint256 chainId, bytes txInfo, bytes extraInfo) returns()
func (_DepositManagerContract *DepositManagerContractSession) RecordWithdrawal(targetAddress common.Address, amount *big.Int, chainId *big.Int, txInfo []byte, extraInfo []byte) (*types.Transaction, error) {
	return _DepositManagerContract.Contract.RecordWithdrawal(&_DepositManagerContract.TransactOpts, targetAddress, amount, chainId, txInfo, extraInfo)
}

// RecordWithdrawal is a paid mutator transaction binding the contract method 0x57673f43.
//
// Solidity: function recordWithdrawal(address targetAddress, uint256 amount, uint256 chainId, bytes txInfo, bytes extraInfo) returns()
func (_DepositManagerContract *DepositManagerContractTransactorSession) RecordWithdrawal(targetAddress common.Address, amount *big.Int, chainId *big.Int, txInfo []byte, extraInfo []byte) (*types.Transaction, error) {
	return _DepositManagerContract.Contract.RecordWithdrawal(&_DepositManagerContract.TransactOpts, targetAddress, amount, chainId, txInfo, extraInfo)
}
