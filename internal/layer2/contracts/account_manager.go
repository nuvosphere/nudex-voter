...
// SubmitRegisterTask is a paid mutator transaction binding the contract method 0x3e4f1097.
//
// Solidity: function submitRegisterTask(address _userAddr, uint256 _account, uint8 _chain, uint256 _index) returns(uint64)
func (_AccountManagerContract *AccountManagerContractTransactor) SubmitRegisterTask(opts *bind.TransactOpts, _userAddr common.Address, _account *big.Int, _chain uint8, _index *big.Int) (*types.Transaction, error) {
...
//
// Solidity: function submitRegisterTask(address _userAddr, uint256 _account, uint8 _chain, uint256 _index) returns(uint64)
func (_AccountManagerContract *AccountManagerContractSession) SubmitRegisterTask(_userAddr common.Address, _account *big.Int, _chain uint8, _index *big.Int) (*types.Transaction, error) {
...
//
// Solidity: function submitRegisterTask(address _userAddr, uint256 _account, uint8 _chain, uint256 _index) returns(uint64)
func (_AccountManagerContract *AccountManagerContractTransactorSession) SubmitRegisterTask(_userAddr common.Address, _account *big.Int, _chain uint8, _index *big.Int) (*types.Transaction, error) {
	return _AccountManagerContract.Contract.SubmitRegisterTask(&_AccountManagerContract.TransactOpts, _userAddr, _account, _chain, _index)
}
