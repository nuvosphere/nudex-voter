...
// GetRandomParticipant is a free data retrieval call binding the contract method 0x73289b13.
//
// Solidity: function getRandomParticipant(uint256 _salt) view returns(address randParticipant)
func (_ParticipantManagerContract *ParticipantManagerContractCaller) GetRandomParticipant(opts *bind.CallOpts, _salt *big.Int) (common.Address, error) {
	var out []interface{}
...
//
// Solidity: function getRandomParticipant(uint256 _salt) view returns(address randParticipant)
func (_ParticipantManagerContract *ParticipantManagerContractSession) GetRandomParticipant(_salt *big.Int) (common.Address, error) {
...
//
// Solidity: function getRandomParticipant(uint256 _salt) view returns(address randParticipant)
func (_ParticipantManagerContract *ParticipantManagerContractCallerSession) GetRandomParticipant(_salt *big.Int) (common.Address, error) {
	return _ParticipantManagerContract.Contract.GetRandomParticipant(&_ParticipantManagerContract.CallOpts, _salt)
}
...
//
// Solidity: function addParticipant(address newParticipant) returns(bytes)
...
//
// Solidity: function removeParticipant(address participant) returns(bytes)
